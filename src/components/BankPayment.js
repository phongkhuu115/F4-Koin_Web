...
function Bank(props) {
  return (
    <div className=''>
      <select className="form-select fs-4 py-2 px-4 mb-4" id="bankSelect">
      ...
      <div className="mb-4 mt-3 fs-3">
        <label htmlFor="bankNum" className="form-label fw-bold mb-3">Số tài khoản: </label>
        <input type="email" className="form-control fs-4 py-2 px-4" id="bankNum" placeholder="099xxxxxxxx" />
      </div>
      <label htmlFor="shipSelect" className="fs-3 fw-bold mb-3">Hình thức vận chuyển: </label>
      <select className="form-select fs-4 py-2 px-4" id="shipSelect">

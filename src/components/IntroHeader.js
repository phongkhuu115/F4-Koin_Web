      ...
      <div className="IntroHeader">
        <header className="navbar container-fluid p-3">
          <div className="header-logo d-flex align-items-center">
            <a><Link to='/' className='text-decoration-none'><div className="ms-5 me-3 px-4 py-3 bg-dark text-light fs-2">F4</div></Link></a>
            <a><Link to='/' className="navbar-brand ms-4 text-uppercase fw-bold fs-2">Koi Store</Link></a>
          </div>
